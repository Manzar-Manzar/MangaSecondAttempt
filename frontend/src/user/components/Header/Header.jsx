            ...
            <nav className="bg-gray-800 text-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        <h2 
                            className="mr-3 hover:text-orange-800 focus:ring-4 focus:ring-gray-300 font-medium text-lg px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
                            alt="Logo">Manga Translate</h2>
                    </Link>
